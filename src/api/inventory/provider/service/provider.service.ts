...
export class ProviderService {
    ...
    async createEntity(
      ...
      async UpdateProviderStatus(providerId: string, updateProviderStatusDto: UpdateProviderStatusDto) {
        return await this.providerRepository.UpdateProviderStatus(providerId, updateProviderStatusDto)
      }
}