...
@Injectable()
export class KycRepository extends Repository<KycEntity> implements RepositoriesAbstract<KycEntity,CreateKycDto>{
    ...
    async updateEntity(id: string, updateEntityDto: never): Promise<UpdateResult> {
