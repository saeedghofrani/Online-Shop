...
export class FileRepository
    ...
    implements
    RepositoriesAbstract<FileEntity, CreateFileDto, UpdateFileDto>
{
    constructor(
    ...
    async findAllEntities(): Promise<FileEntity[]> {
        return await this.createQueryBuilder('file').where('file.type != :type', { type: FileTypeEnum.HIDDEN }).getMany();
    }
