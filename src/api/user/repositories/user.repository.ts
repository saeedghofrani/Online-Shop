...
@Injectable()
export class UserRepository extends Repository<UserEntity> implements RepositoriesAbstract<UserEntity,CreateUserDto,UpdateUserDto>{
   ...
   async createEntity(createEntityDto: CreateUserDto): Promise<UserEntity> {
    ...
    async updateEntity(id: string, updateEntityDto: UpdateUserDto): Promise<UpdateResult> {
